...
public class DPProcessors
{
	...
	public static final StructureProcessorList TOWER_PROCESSOR = register("tower_processor", RegistryHelper.combineProcessors(COBBLE_TO_MOSSY, new RandomBlockSwapProcessor(Blocks.STONE_BRICKS, 0.15F, Blocks.MOSSY_STONE_BRICKS), new RandomBlockSwapProcessor(Blocks.STONE_BRICKS, 0.3F, Blocks.CRACKED_STONE_BRICKS)));
